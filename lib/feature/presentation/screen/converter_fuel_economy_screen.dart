...
class _ConverterFuelScreenState extends State<ConverterFuelScreen> {
  final _controller = TextEditingController(text: "7.5");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Fuel Economy", style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Icon(Icons.compare_arrows, color: fuelMint, size: 30),
  ...
  Widget _buildDropdown(FuelEconomyUnit value, Function(FuelEconomyUnit) onChanged, Color color) {
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<FuelEconomyUnit>(
          ...
          items: FuelEconomyUnit.values.map((unit) => DropdownMenuItem(
            value: unit,
