...
import 'package:totalUnit/feature/domain/extensions/speed_unit_extension.dart';
import 'package:totalUnit/feature/domain/services/converter_speed_service.dart';
...
class _ConverterSpeedScreenState extends State<ConverterSpeedScreen> {
  ...
  Widget build(BuildContext context) {
    const speedCyan = Color(0xFF00E5FF);
    return Scaffold(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: speedCyan.withValues(alpha: 0.1)),
              ),
              child: TextField(
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: speedCyan.withValues(alpha: 0.15),
                        shape: BoxShape.circle,
                      ),
                      child: const Icon(Icons.swap_horiz, color: speedCyan, size: 24),
                    ),
                  ),
                ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: speedCyan.withValues(alpha: 0.05), blurRadius: 20, spreadRadius: 1),
                ],
                ...
                children: [
                  ...
                  FittedBox(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(fontSize: 54, fontWeight: FontWeight.bold, color: speedCyan),
                    ),
                  ),
  ...
  Widget _buildDropdownColumn(String title, SpeedUnit value, ValueChanged<SpeedUnit?> onChanged, Color accentColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<SpeedUnit>(
              ...
              items: SpeedUnit.values.map((u) => DropdownMenuItem(
                value: u,
                child: Text(u.label,
