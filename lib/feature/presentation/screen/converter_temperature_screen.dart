...
import 'package:totalUnit/feature/domain/extensions/temperature_unit_extension.dart';
import 'package:totalUnit/feature/domain/services/converter_temperature_service.dart';
...
class _ConverterTemperatureScreenState extends State<ConverterTemperatureScreen> {
  final _controller = TextEditingController(text: "25.00");
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: tempOrange.withValues(alpha: 0.1)),
              ),
              child: TextField(
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: tempOrange.withValues(alpha: 0.15),
                        shape: BoxShape.circle,
                      ),
                      child: const Icon(Icons.swap_horiz, color: tempOrange, size: 24),
                    ),
                  ),
                ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(color: tempOrange.withValues(alpha: 0.05), blurRadius: 20, spreadRadius: 1),
                ],
                ...
                children: [
                  ...
                  FittedBox(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(fontSize: 54, fontWeight: FontWeight.bold, color: tempOrange),
                    ),
                  ),
  ...
  Widget _buildDropdownColumn(String title, TemperatureUnit value, ValueChanged<TemperatureUnit?> onChanged, Color accentColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<TemperatureUnit>(
              ...
              items: TemperatureUnit.values.map((u) => DropdownMenuItem(
                value: u,
                child: Text(u.label,
